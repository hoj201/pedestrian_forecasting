...
\todo[inline]{for the love of god please don't forget to write the actual abstract}
\end{abstract}
...
We then computed the ROC curve at each frame for each predictor, and the AUC of that curve. \todo[inline]{How much detail should I put about why we chose to use the AUC as a metric?} The AUCs at each time step were averaged across all test trajectories, and across all scenes. This formed the plot of mean AUC vs time ({figure n+1}). 
