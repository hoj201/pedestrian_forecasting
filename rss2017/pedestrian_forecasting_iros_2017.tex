...
\end{align}
The final term $\Pr( x_t, lin \mid \hat{x}_0, \hat{v}_0 )$ is expressible in terms of the error function \Ram{what error function?} \Hoj{The error function is a special function.  It's proportional to the CDF of the normal distribution.}, and would pose a negligible burden in terms of numerical computation.
