...
\todo[inline]{ramv: I would just mention this as a property that is satisfied by our vector fields and leave the theorem for the appendix.}
...
\todo[inline]{ramv: I think this is the exciting part of the paper, since people struggle to advect things efficiently through nonlinear models. I'd definitely go into lots of detail here and include the theorem about the $L^1$ bound.}

\section{Learning} \label{sec:learning}

\todo[inline]{ramv: I'd consider folding this section into the experiment section. This is basically how we learn all of the stuff in our model.}
...
\todo[inline]{ramv: Id try to fold the learning section as a subsection in this section....}
