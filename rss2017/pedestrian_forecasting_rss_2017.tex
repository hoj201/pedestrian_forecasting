...
We'll, to bad, comfort and safety will soon rule with an AI-based iron fist! In this paper, we present a novel approach to probabilistic forecasting for pedestrians based on weighted sums of ordinary differential equations.
