...
\begin{split}
	& P(c_k \mid \eta_0 , \mu_0 ) = \\
	&\quad \frac{1}{2\pi \sigma_m \sigma_v} \int \exp \left( \frac{ - \| x_0 - \mu_0 \| }{ 2 \sigma_m^2} + \frac{ - \| \eta_0 - X_c( x_0 ) \| }{ 2 \sigma_v^2} \right) dx_0 
...
\begin{align*}
	...
	&= \frac{1}{ 2\pi \sigma_x \sigma_v } \int \exp \left( \frac{ - \| x_T - Tv_0 \| }{ 2 \sigma_x^2} + \frac{ - \| v_0 - \eta_0 \|^2 }{ 2 \sigma_v^2 } \right) dv_0 
\end{align*}
