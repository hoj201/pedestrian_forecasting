...
\begin{figure}
	...
	\end{minipage}
	\begin{minipage}[t]{0.3\linewidth}
		\includegraphics[width=\linewidth]{./figures/coupa/ours_1_4_t=50.png}
	\end{minipage}
	\begin{minipage}[t]{0.3\linewidth}
		\includegraphics[width=\linewidth]{./figures/coupa/ours_1_4_t=170.png}
	\end{minipage}
	\begin{minipage}[t]{0.3\linewidth}
		\includegraphics[width=\linewidth]{./figures/coupa/ours_1_4_t=355.png}
	\end{minipage}
	...
	\end{minipage}
	\begin{minipage}[t]{0.3\linewidth}
		\includegraphics[width=\linewidth]{./figures/coupa/kit_1_4_t=50.png}
	\end{minipage}
	\begin{minipage}[t]{0.3\linewidth}
		\includegraphics[width=\linewidth]{./figures/coupa/kit_1_4_t=170.png}
	\end{minipage}
	\begin{minipage}[t]{0.3\linewidth}
		\includegraphics[width=\linewidth]{./figures/coupa/kit_1_4_t=355.png}
	\end{minipage}
	...
	\end{minipage}
	\begin{minipage}[t]{0.3\linewidth}
		\includegraphics[width=\linewidth]{./figures/coupa/rand_1_4_t=50.png}
	\end{minipage}
	\begin{minipage}[t]{0.3\linewidth}
		\includegraphics[width=\linewidth]{./figures/coupa/rand_1_4_t=170.png}
	\end{minipage}
	\begin{minipage}[t]{0.3\linewidth}
		\includegraphics[width=\linewidth]{./figures/coupa/rand_1_4_t=355.png}
	\end{minipage}
	...
	\begin{minipage}{0.3\linewidth}
		...
		$t = 11.83s$
	\end{minipage}
	\caption{Here we see how Kitani et al.'s algorithm finds a local minimum and so never reaches the terminal point we give it. Our algorithm doesn't solve an optimization problem online, and so our algorithm avoids that pitfall.}
	\label{fig:coupa-1-4}
\end{figure}
...
The output distributions of the three algorithms were compared using their integrals over the cells of a suitably fine regular grid over our domain. These integrals are used to visualize the distributions in Figures \ref{fig:death-1-2}, \ref{fig:coupa-1-4}, and \ref{fig:bookstore-1-2}.
